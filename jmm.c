...
void login(){
    ...
    for(int i=1; i < 11; i++){
        if(!strcmp(players[0].nome, players[i].nome)){
            printf("Seja bem vindo de volta %s!", players[i].nome);
            printf("Seu recorde foi: %d", players[i].pontos);
            break;
        }
    }
...
login();
   ...
   int menu;
    ...
    switch(menu){
        ...
        case 2:
        printf("Chamar funcao do jogo contra");
        break;
